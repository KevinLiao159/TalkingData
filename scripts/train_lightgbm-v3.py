...
# read data
df_train = pd.read_hdf('../data/train_v3.hdf').astype('float32')
gc.collect()
# col
...
# save model
# model.save_model('model_v3.txt')
# clean up
# del model
gc.collect()
####################################################################
# submit
df_test = pd.read_hdf('../data/test_v3.hdf')
# pred
...
# save
df_sub.to_csv('../data/submission_v3.csv', index=False)
